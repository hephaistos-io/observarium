 ...
 *
 * <p>All nested config classes use getters/setters (not records) so that Spring's
 * {@link ConfigurationProperties} binding mechanism can populate them via reflection.
 */
