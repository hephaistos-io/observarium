 ...
 *
 * @param token       GitHub Personal Access Token or app installation token.
 *                    Must have {@code repo} scope (or {@code public_repo} for public repos).
 * @param owner       GitHub repository owner — an organization name or a user login.
 * @param repo        GitHub repository name.
 * @param labelPrefix Label applied to all issues created by Observarium.
 *                    Defaults to {@code "observarium"} when {@code null} is supplied.
 */
