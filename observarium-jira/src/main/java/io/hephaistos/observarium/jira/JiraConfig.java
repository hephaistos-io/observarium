 ...
 *
 * <p>{@code baseUrl} is the root URL of the Jira instance, e.g. {@code
 * https://mycompany.atlassian.net}. {@code username} is the email address used to authenticate with
 * Jira Cloud. {@code apiToken} is the personal API token that pairs with {@code username}. {@code
 * projectKey} is the Jira project key, e.g. {@code OBS}. {@code issueType} is the name of the issue
 * type to create, defaults to {@code Bug}.
 */
public record JiraConfig(
    String baseUrl, String username, String apiToken, String projectKey, String issueType) {
