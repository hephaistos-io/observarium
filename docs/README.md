...
|---|---|
| [Getting Started](getting-started.md) | Setup guide for plain Java, Spring Boot, and Quarkus |
| [Configuration](configuration.md) | Builder API reference, Spring Boot and Quarkus properties, scrub levels, async behavior |
