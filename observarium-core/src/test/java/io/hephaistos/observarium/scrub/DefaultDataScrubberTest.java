...
class DefaultDataScrubberTest {
    ...
    void basicLevel_redactsCredentialKeyValuePairs(String input) {
        ...
        assertTrue(result.contains(REDACTED),
            "Expected BASIC scrubber to redact: " + input);
    }
    ...
    void basicLevel_doesNotRedactEmails() {
        ...
        assertTrue(result.contains("user@example.com"),
            "BASIC level must not redact email addresses");
    }
    ...
    void basicLevel_doesNotRedactIpAddresses() {
        ...
        assertTrue(result.contains("192.168.1.100"),
            "BASIC level must not redact IP addresses");
    }
    ...
    void strictLevel_redactsPhoneNumbers(String input) {
        ...
        String result = scrubber.scrub(input);
        assertTrue(result.contains(REDACTED),
            "Phone number must be redacted at STRICT level: " + input);
    }
