...
class ExceptionEventTest {
    ...
    void builder_storesAllExplicitFields() {
        ...
        assertAll("all explicitly set fields must be preserved",
    ...
    void builder_defaultTimestampIsPopulated() {
        ...
        assertFalse(event.timestamp().isAfter(after),
            "Default timestamp must not be after the test completed");
    }
    ...
    void tags_isCopiedOnSet_originalMutationDoesNotAffectEvent() {
        ...
        assertEquals(1, event.tags().size(),
            "Mutating the original map must not affect the stored tags");
    }
    ...
    void extra_isCopiedOnSet_originalMutationDoesNotAffectEvent() {
        ...
        assertEquals(1, event.extra().size(),
            "Mutating the original map must not affect the stored extra");
    }
    ...
    void twoEventsWithSameFields_areEqual() {
        ...
        ExceptionEvent a = ExceptionEvent.builder()
            .fingerprint("fp")
            .exceptionClass("Ex")
            .message("msg")
        ...
        ExceptionEvent b = ExceptionEvent.builder()
            .fingerprint("fp")
            .exceptionClass("Ex")
            .message("msg")
            .severity(Severity.INFO)
