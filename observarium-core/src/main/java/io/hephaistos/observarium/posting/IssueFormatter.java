 ...
 * titles, bodies, and follow-up comments. The default implementation is
 * {@link DefaultIssueFormatter}. Provide a custom implementation to change formatting — for
 * example, to use a different title convention, to include additional fields, or to produce
...
public interface IssueFormatter {
     ...
     * every issue they create and then search for it by fingerprint value when implementing
     * {@link PostingService#findDuplicate}.
     *
     ...
     *
     * <p>The body should include the {@link #fingerprintMarker(String)} so that future
     * occurrences can be correlated via {@link PostingService#findDuplicate}.
     *
     ...
     * {@link PostingService#commentOnIssue}.
     *
