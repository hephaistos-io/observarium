 ...
 *
 * <p>Titles use the unqualified exception class name and up to 80 characters of the message.
 * Bodies include exception details, severity, timestamp, thread name, optional tracing IDs,
 * user-supplied tags, and the full raw stack trace. Follow-up comments record the new
 * occurrence without repeating the stack trace.
 *
